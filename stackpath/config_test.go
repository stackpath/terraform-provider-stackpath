// This file is copied from https://github.com/hashicorp/terraform-plugin-sdk/blob/v1.15.0/helper/pathorcontents/read_test.go
// to support tests for pathOrContentsRead(). The original pathorcontents.Read()
// was provided in version 1 of the Terraform provider SDK and copied into this
// package to prevent refactoring calling code after migrating to provider SDK 2.
...
func TestRead_Path(t *testing.T) {
	...
	contents, wasPath, err := pathOrContentsRead(f.Name())
...
func TestRead_TildePath(t *testing.T) {
	...
	contents, wasPath, err := pathOrContentsRead(homePath)
...
func TestRead_Contents(t *testing.T) {
	...
	contents, wasPath, err := pathOrContentsRead(input)
