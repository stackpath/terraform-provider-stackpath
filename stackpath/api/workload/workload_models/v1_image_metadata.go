...
func (m *V1ImageMetadata) contextValidateCreatedAt(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ImageMetadata) contextValidateUpdatedAt(ctx context.Context, formats strfmt.Registry) error {
