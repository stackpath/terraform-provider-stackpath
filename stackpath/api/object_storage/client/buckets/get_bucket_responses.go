...
type GetBucketOK struct {
	Payload *models.GetBucketOKBody
}
...
type GetBucketUnauthorized struct {
	Payload *models.GetBucketUnauthorizedBody
}
...
func (o *GetBucketUnauthorized) GetPayload() *models.GetBucketUnauthorizedBody {
	return o.Payload
}
...
func (o *GetBucketUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetBucketUnauthorizedBody)
...
type GetBucketInternalServerError struct {
	Payload *models.GetBucketInternalServerErrorBody
}
...
func (o *GetBucketInternalServerError) GetPayload() *models.GetBucketInternalServerErrorBody {
	return o.Payload
}
...
func (o *GetBucketInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetBucketInternalServerErrorBody)
...
type GetBucketDefault struct {
	...
	Payload *models.GetBucketDefaultBody
}
...
func (o *GetBucketDefault) GetPayload() *models.GetBucketDefaultBody {
	return o.Payload
}
...
func (o *GetBucketDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetBucketDefaultBody)
