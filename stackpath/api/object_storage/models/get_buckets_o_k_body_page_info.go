...
func (m *GetBucketsOKBodyPageInfo) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *GetBucketsOKBodyPageInfo) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetBucketsOKBodyPageInfo) UnmarshalBinary(b []byte) error {
