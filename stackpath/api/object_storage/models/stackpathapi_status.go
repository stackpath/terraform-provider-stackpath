...
type StackpathapiStatus struct {
	...
	detailsField []StackpathapiStatusDetailsItems
...
func (m *StackpathapiStatus) Details() []StackpathapiStatusDetailsItems {
	return m.detailsField
}

// SetDetails sets the details of this base type
func (m *StackpathapiStatus) SetDetails(val []StackpathapiStatusDetailsItems) {
	m.detailsField = val
}
...
func (m *StackpathapiStatus) UnmarshalJSON(raw []byte) error {
	...
	var propDetails []StackpathapiStatusDetailsItems
	if string(data.Details) != "null" {
		details, err := UnmarshalStackpathapiStatusDetailsItemsSlice(bytes.NewBuffer(data.Details), runtime.JSONConsumer())
...
func (m StackpathapiStatus) MarshalJSON() ([]byte, error) {
	...
	b2, err = json.Marshal(struct {
		Details []StackpathapiStatusDetailsItems `json:"details"`
	}{
