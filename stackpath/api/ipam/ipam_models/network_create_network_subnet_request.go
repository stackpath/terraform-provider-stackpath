...
// NetworkCreateNetworkSubnetRequest A request to create a new subnet in a network
//
...
func (m *NetworkCreateNetworkSubnetRequest) validateSubnet(formats strfmt.Registry) error {
...
func (m *NetworkCreateNetworkSubnetRequest) contextValidateSubnet(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkCreateNetworkSubnetRequest) UnmarshalBinary(b []byte) error {
	var res NetworkCreateNetworkSubnetRequest
