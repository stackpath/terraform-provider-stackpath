...
func (m *V1GetNetworkPoliciesResponse) contextValidatePageInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1GetNetworkPoliciesResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
