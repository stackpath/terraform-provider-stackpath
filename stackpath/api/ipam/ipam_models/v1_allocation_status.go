...
//
// swagger:model v1AllocationStatus
type V1AllocationStatus struct {
	...
	// parent allocation
	ParentAllocation string `json:"parentAllocation,omitempty"`
...
// ContextValidate validate this v1 allocation status based on the context it is used
func (m *V1AllocationStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AllocationStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
