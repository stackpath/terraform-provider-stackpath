...
// NetworkCreateNetworkSubnetResponse A response from a request to create a subnet
//
...
func (m *NetworkCreateNetworkSubnetResponse) validateSubnet(formats strfmt.Registry) error {
...
func (m *NetworkCreateNetworkSubnetResponse) contextValidateSubnet(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkCreateNetworkSubnetResponse) UnmarshalBinary(b []byte) error {
	var res NetworkCreateNetworkSubnetResponse
