...
// V1CreateNetworkPolicyRequest A request to create a network policy
//
...
func (m *V1CreateNetworkPolicyRequest) contextValidateNetworkPolicy(ctx context.Context, formats strfmt.Registry) error {
