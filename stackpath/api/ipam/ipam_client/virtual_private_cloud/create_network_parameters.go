...
func (o *CreateNetworkParams) WithBody(body *ipam_models.NetworkCreateNetworkRequest) *CreateNetworkParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create network params
func (o *CreateNetworkParams) SetBody(body *ipam_models.NetworkCreateNetworkRequest) {
	o.Body = body
}
