...
// WithOperationName adds the operationName to the get operation params
func (o *GetOperationParams) WithOperationName(operationName string) *GetOperationParams {
	o.SetOperationName(operationName)
	return o
}

// SetOperationName adds the operationName to the get operation params
func (o *GetOperationParams) SetOperationName(operationName string) {
	o.OperationName = operationName
}

// WithStackID adds the stackID to the get operation params
func (o *GetOperationParams) WithStackID(stackID string) *GetOperationParams {
	o.SetStackID(stackID)
	return o
}

// SetStackID adds the stackId to the get operation params
func (o *GetOperationParams) SetStackID(stackID string) {
	o.StackID = stackID
}
