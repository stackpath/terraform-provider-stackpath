...
// NewHTTPClient creates a new edge compute networking HTTP client.
func NewHTTPClient(formats strfmt.Registry) *EdgeComputeNetworking {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new edge compute networking HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *EdgeComputeNetworking {
...
// New creates a new edge compute networking client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *EdgeComputeNetworking {
	// ensure nullable parameters have default
	if formats == nil {
