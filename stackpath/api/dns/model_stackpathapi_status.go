...
// checks if the StackpathapiStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StackpathapiStatus{}
...
func (o StackpathapiStatus) ToMap() (map[string]interface{}, error) {
