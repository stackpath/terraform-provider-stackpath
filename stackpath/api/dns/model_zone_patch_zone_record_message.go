...
// checks if the ZonePatchZoneRecordMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZonePatchZoneRecordMessage{}
...
func (o ZonePatchZoneRecordMessage) ToMap() (map[string]interface{}, error) {
