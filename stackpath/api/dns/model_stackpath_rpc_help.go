...
// checks if the StackpathRpcHelp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StackpathRpcHelp{}
...
func NewStackpathRpcHelp(type_ string) *StackpathRpcHelp {
...
func (o StackpathRpcHelp) ToMap() (map[string]interface{}, error) {
