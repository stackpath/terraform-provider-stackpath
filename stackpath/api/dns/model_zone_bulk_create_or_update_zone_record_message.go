...
// checks if the ZoneBulkCreateOrUpdateZoneRecordMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneBulkCreateOrUpdateZoneRecordMessage{}
...
func (o ZoneBulkCreateOrUpdateZoneRecordMessage) ToMap() (map[string]interface{}, error) {
