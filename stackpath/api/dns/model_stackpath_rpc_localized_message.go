...
// checks if the StackpathRpcLocalizedMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StackpathRpcLocalizedMessage{}
...
func NewStackpathRpcLocalizedMessage(type_ string) *StackpathRpcLocalizedMessage {
...
func (o StackpathRpcLocalizedMessage) ToMap() (map[string]interface{}, error) {
