...
// checks if the ZoneGetZoneRecordsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneGetZoneRecordsResponse{}
...
func (o ZoneGetZoneRecordsResponse) ToMap() (map[string]interface{}, error) {
