...
// checks if the PrometheusMetrics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrometheusMetrics{}
...
func (o PrometheusMetrics) ToMap() (map[string]interface{}, error) {
