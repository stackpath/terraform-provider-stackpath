...
// checks if the ZoneParseRecordsFromZoneFileResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneParseRecordsFromZoneFileResponse{}
...
func (o ZoneParseRecordsFromZoneFileResponse) ToMap() (map[string]interface{}, error) {
