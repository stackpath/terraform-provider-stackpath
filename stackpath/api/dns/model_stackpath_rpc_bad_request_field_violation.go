...
// checks if the StackpathRpcBadRequestFieldViolation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StackpathRpcBadRequestFieldViolation{}
...
func (o StackpathRpcBadRequestFieldViolation) ToMap() (map[string]interface{}, error) {
