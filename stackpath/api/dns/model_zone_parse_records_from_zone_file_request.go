...
// checks if the ZoneParseRecordsFromZoneFileRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneParseRecordsFromZoneFileRequest{}
...
func (o ZoneParseRecordsFromZoneFileRequest) ToMap() (map[string]interface{}, error) {
