...
// checks if the DataVectorResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataVectorResult{}
...
func (o DataVectorResult) ToMap() (map[string]interface{}, error) {
