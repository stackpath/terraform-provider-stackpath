...
// checks if the ZoneGetDiscoveryProviderDetailsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneGetDiscoveryProviderDetailsResponse{}
...
func (o ZoneGetDiscoveryProviderDetailsResponse) ToMap() (map[string]interface{}, error) {
