...
// checks if the ApiStatusDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiStatusDetail{}
...
func (o ApiStatusDetail) ToMap() (map[string]interface{}, error) {
