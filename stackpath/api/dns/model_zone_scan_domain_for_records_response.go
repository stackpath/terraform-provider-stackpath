...
// checks if the ZoneScanDomainForRecordsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneScanDomainForRecordsResponse{}
...
func (o ZoneScanDomainForRecordsResponse) ToMap() (map[string]interface{}, error) {
