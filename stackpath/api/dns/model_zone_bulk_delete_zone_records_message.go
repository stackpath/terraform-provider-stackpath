...
// checks if the ZoneBulkDeleteZoneRecordsMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneBulkDeleteZoneRecordsMessage{}
...
func (o ZoneBulkDeleteZoneRecordsMessage) ToMap() (map[string]interface{}, error) {
