...
// checks if the DataMatrixResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataMatrixResult{}
...
func (o DataMatrixResult) ToMap() (map[string]interface{}, error) {
