...
// checks if the ZoneCreateZoneResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneCreateZoneResponse{}
...
func (o ZoneCreateZoneResponse) ToMap() (map[string]interface{}, error) {
