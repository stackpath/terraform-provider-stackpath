...
// ContextValidate validate this storage get bucket response based on the context it is used
func (m *StorageGetBucketResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StorageGetBucketResponse) contextValidateBucket(ctx context.Context, formats strfmt.Registry) error {
