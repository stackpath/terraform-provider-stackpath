...
// ContextValidate validate this storage create bucket response based on the context it is used
func (m *StorageCreateBucketResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StorageCreateBucketResponse) contextValidateBucket(ctx context.Context, formats strfmt.Registry) error {
