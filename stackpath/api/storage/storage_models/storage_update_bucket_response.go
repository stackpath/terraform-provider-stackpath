...
// ContextValidate validate this storage update bucket response based on the context it is used
func (m *StorageUpdateBucketResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StorageUpdateBucketResponse) contextValidateBucket(ctx context.Context, formats strfmt.Registry) error {
