...
// ContextValidate validate this storage get buckets response based on the context it is used
func (m *StorageGetBucketsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StorageGetBucketsResponse) contextValidatePageInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageGetBucketsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
