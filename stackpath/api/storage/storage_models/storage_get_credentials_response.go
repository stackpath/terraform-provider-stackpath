...
// ContextValidate validate this storage get credentials response based on the context it is used
func (m *StorageGetCredentialsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StorageGetCredentialsResponse) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
