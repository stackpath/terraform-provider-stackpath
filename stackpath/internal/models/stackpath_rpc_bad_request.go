...
func (m *StackpathRPCBadRequest) AtType() string {
	return "type.stackpathapis.com/stackpath.rpc.BadRequest"
}
...
func (m *StackpathRPCBadRequest) UnmarshalJSON(raw []byte) error {
	...
	result.StackpathRPCBadRequestAllOf1 = data.StackpathRPCBadRequestAllOf1
...
func (m StackpathRPCBadRequest) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		StackpathRPCBadRequestAllOf1: m.StackpathRPCBadRequestAllOf1,
	},
	)
	if err != nil {
		return nil, err
...
func (m *StackpathRPCBadRequest) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with StackpathRPCBadRequestAllOf1
	if err := m.StackpathRPCBadRequestAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
