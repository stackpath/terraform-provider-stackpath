...
func (m *StackpathRPCRetryInfo) AtType() string {
	return "type.stackpathapis.com/stackpath.rpc.RetryInfo"
}
...
func (m *StackpathRPCRetryInfo) UnmarshalJSON(raw []byte) error {
	...
	result.StackpathRPCRetryInfoAllOf1 = data.StackpathRPCRetryInfoAllOf1
...
func (m StackpathRPCRetryInfo) MarshalJSON() ([]byte, error) {
	...
	b1, err = json.Marshal(struct {
		...
		StackpathRPCRetryInfoAllOf1: m.StackpathRPCRetryInfoAllOf1,
	},
	)
	if err != nil {
		return nil, err
...
func (m *StackpathRPCRetryInfo) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with StackpathRPCRetryInfoAllOf1
	if err := m.StackpathRPCRetryInfoAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
