...
/*
DeleteCredential Delete provided storage access credentials for the given user
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param stackId The stack's ID for which the user belongs to
 * @param userId The user's ID for which the credentials will be generated
 * @param accessKey The credentials access key to be removed
*/
...
/*
GenerateCredentials Generate storage credentials for the given user
...
*/
func (a *UserCredentialsApiService) GenerateCredentials(ctx _context.Context, stackId string, userId string) (InlineResponse2006, *_nethttp.Response, error) {
	var (
...
/*
GetCredentials Get credentials for a given user.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param stackId The stack's ID for which the user belongs to
 * @param userId The user's ID for which the credentials belong to
@return InlineResponse2005
*/
func (a *UserCredentialsApiService) GetCredentials(ctx _context.Context, stackId string, userId string) (InlineResponse2005, *_nethttp.Response, error) {
	var (
